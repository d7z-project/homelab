    ...
    <mat-dialog-content>
      <div class="pt-3 space-y-5">
        ...
        <mat-form-field appearance="outline" class="w-full">
          ...
          <textarea matInput [(ngModel)]="sa.comments" placeholder="说明此账号的用途..." rows="3"></textarea>
        </mat-form-field>
      </div>
    </mat-dialog-content>
...
export class CreateSaDialogComponent {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: { sa: AuthServiceAccount | null, existingNames?: string[] }) {
    if (data.sa) {
      this.isEdit = true;
      this.sa = { ...data.sa };
    }
