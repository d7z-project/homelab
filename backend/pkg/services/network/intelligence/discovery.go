...
func RegisterDiscovery() {
	registerDiscoveryOnce.Do(func() {
		...
		_ = registryruntime.Default().RegisterLookup("network/intelligence/sources", func(ctx context.Context, search string, cursor string, limit int) (*shared.PaginationResponse[discoverymodel.LookupItem], error) {
